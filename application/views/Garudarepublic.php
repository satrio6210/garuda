...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="icon/Garudarepublicicon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="icon/Garudarepublicicon/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="icon/Garudarepublicicon/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="icon/Garudarepublicicon/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="icon/Garudarepublicicon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="icon/Garudarepublicicon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="icon/Garudarepublicicon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="icon/Garudarepublicicon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="icon/Garudarepublicicon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"  href="icon/Garudarepublicicon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="icon/Garudarepublicicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="icon/Garudarepublicicon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="icon/Garudarepublicicon/favicon-16x16.png">
    <link rel="manifest" href="icon/Garudarepublicicon/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="icon/Garudarepublicicon/ms-icon-144x144.png">
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="https://zkillboard.com/corporation/98230717/" target="_blank">ZKillboard</a>
                    </li>
                    <li>
    ...
    <header class="image-bg-fluid-height">
        <img class="img-responsive img-center" src="https://imageserver.eveonline.com/Corporation/98230717_128.png" alt="">
    </header>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                  <h1 class="section-heading">Garuda Republic</h1>
                  ...
                  <p class="lead section-lead">We belong to all indonesian player in the entire new eden as a symbol of strongly united community</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                  ...
                  &nbsp; 
                  <a href="<?php echo base_url("/Welcome/Wyzen");?>">
                  <img src="https://imageserver.eveonline.com/Corporation/98500194_128.png" class="img-thumbnail img-responsive" alt="Placeholder image">
                  </a>
                  &nbsp;
                  ...
                  <p class="section-paragraph"></p>
                  <p class="lead section-lead">Garuda Union are not on it's own but bounded together with other corporation to become stronger in many aspect</p>
