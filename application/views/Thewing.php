...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="icon/Thewingicon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="icon/Thewingicon/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="icon/Thewingicon/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="icon/Thewingicon/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="icon/Thewingicon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="icon/Thewingicon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="icon/Thewingicon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="icon/Thewingicon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="icon/Thewingicon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"  href="icon/Thewingicon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="icon/Thewingicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="icon/Thewingicon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="icon/Thewingicon/favicon-16x16.png">
    <link rel="manifest" href="icon/Thewingicon/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="icon/Thewingicon/ms-icon-144x144.png">
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="https://zkillboard.com/corporation/98457145/" target="_blank">ZKillboard</a>
                    </li>
                    <li>
    ...
    <header class="image-bg-fluid-height">
        <img class="img-responsive img-center" src="https://imageserver.eveonline.com/Corporation/98457145_128.png" alt="">
    </header>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                  <h1 class="section-heading">The wing of Garuda</h1>
